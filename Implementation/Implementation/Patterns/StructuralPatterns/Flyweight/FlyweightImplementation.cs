...
{
    internal class FlyweightImplementation : IPatternImplementationStrategy
    {
        ...
        private static void AddSymbolToDictionary(CharacterFactory factory, char symbol, int size, string font)
        {
